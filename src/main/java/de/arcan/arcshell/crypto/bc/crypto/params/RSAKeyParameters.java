...
import de.arcan.arcshell.crypto.bc.util.Properties;
    ...
    extends AsymmetricKeyParameter
{
    ...
    private static BigInteger validate(BigInteger modulus, boolean isInternal)
    {
        ...
        // your keys.
        if (Properties.isOverrideSet("de.arcan.arcshell.crypto.bc.rsa.allow_unsafe_mod"))
        {
            return modulus;
        }

        int maxBitLength = Properties.asInteger("de.arcan.arcshell.crypto.bc.rsa.max_size", 16384);
        ...
        int iterations = Properties.asInteger("de.arcan.arcshell.crypto.bc.rsa.max_mr_tests", getMRIterations(bits));
